...
namespace ZeroOne
{
    public partial class Signup : Form
    {
        ...
        private void signup_login_Click_1(object sender, EventArgs e)
        {
                        ...
                        using (SqlCommand checkUser = new SqlCommand(checkUsername, connect))
                        {
                            ...
                            else
                            {
                                ...
                                using (SqlCommand cmd = new SqlCommand(insertData, connect))
                                {
                                    ...
                                    cmd.ExecuteNonQuery();
                                    MessageBox.Show("Regitered Successfully", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
